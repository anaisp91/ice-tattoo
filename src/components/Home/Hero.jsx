export const Hero = () => {
  return (
    <section className="flex flex-col items-center gap-8 pt-14  md:flex-row bg-[var(--color-black)]">
      <div
        className="text-center pb-5
            md:flex-1 md:pl-6"
      >
        <h1
          className=" text-5xl tracking-wide uppercase p-2 text-[var(--color-sand)] md:text-5xl md:tracking-wider lg:text-6xl"
