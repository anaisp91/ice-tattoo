export const faqData = [
  {
    ...
    answer:
      "Tattoo prices depend on the size, placement, style and complexity of the design. Once I know the details of your idea, I can give you a more accurate estimate.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "I specialise in Traditional and Fine Line tattoos, with a particular interest in Traditional artwork inspired by Ancient Egypt, historical imagery and old-school tattoo aesthetics.",
  },
  {
    question: "Can I bring my own tattoo design or references?",
    answer:
      "Absolutely. You can send drawings, images or tattoo references that help communicate your idea. They are useful for understanding the style, composition and details you have in mind.",
  },
  {
    question: "How should I prepare for my tattoo appointment?",
    answer:
      "Get a good night's sleep, eat before your appointment and stay well hydrated. Avoid arriving with sunburn or irritated skin, and follow any specific preparation instructions provided before your session.",
  },
  {
    question: "How long does a tattoo take to heal?",
    answer:
      "Healing time varies depending on the size, placement and individual skin. The surface of a tattoo generally heals within a few weeks, while the deeper layers of skin can take longer to fully recover.",
  },
  {
